# GPU-accelerated development script for Reikn (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Reikn" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Reikn in development mode..." -ForegroundColor Blue
Write-Host ""
