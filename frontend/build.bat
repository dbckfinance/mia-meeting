@echo off
REM Reikn Build Script for Windows
...
echo 🚀 Building Reikn application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Reikn Tauri application for Windows.
