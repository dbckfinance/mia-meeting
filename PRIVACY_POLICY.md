# Reikn Privacy Policy

*Last updated: [Current Date]*

## Our Privacy-First Commitment

Reikn is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
Usage analytics is optional and off by default. When you choose to enable it, Reikn collects minimal, anonymized usage data:
...
- **GitHub Issues**: [Create an issue](https://github.com/dbckfinance/mia-meeting/issues)
- **Email**: [reikn.com](https://reikn.com)
- **Website**: [reikn.com](https://reikn.com)
...
*This privacy policy applies to Reikn v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*
