...
When **reviewing recordings** in Reikn, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Reikn records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Reikn recordings** - Use wired/speakers instead
...
### This is Not a Reikn Bug

The issue is in **macOS's Bluetooth audio stack**, not in Reikn's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Reikn bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Reikn now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Reikn v0.0.5+ on macOS
