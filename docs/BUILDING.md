# Building Reikn from Source

This guide provides detailed instructions for building Reikn from source on different operating systems.
...
This guide helps you build Reikn on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/Reikn_<version>_amd64.AppImage
```
