...
console.log(`GitHub Repository: dbckfinance/mia-meeting`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/dbckfinance/mia-meeting/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/dbckfinance/mia-meeting/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/dbckfinance/mia-meeting/releases/latest/download/latest.json`);
