...
- Artifacts prefixed with `reikn-test-`
...
```
reikn-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `reikn-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `reikn-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `reikn-macos-aarch64-release-0.1.3`
...
- `REIKN_RSA_PUBLIC_KEY` - License validation public key
